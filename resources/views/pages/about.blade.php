...
@section('content')
    <div class="max-w-4xl mx-auto my-10 p-6 bg-white rounded-lg shadow-lg max-sm:text-sm">
        <h1 class="text-3xl font-bold text-center mb-6 text-[#34BDFF]  max-sm:text-xl">@lang('messages.about.heading')</h1>
        ...
        <div class="text-center">
            <p class="text-lg text-gray-700 mb-6">@lang('messages.about.cta_text')</p>
            <a href="{{ route('contact') }}"
                class="inline-block px-6 py-3 bg-[#34BDFF] hover:bg-[#0DB0FF] text-white font-semibold rounded-lg shadow  transition-colors duration-300">
