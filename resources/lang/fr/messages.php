...
return [
    ...
    'serviceShow' => [
        ...
        'service_price' => 'Tarif du service',
        'advantages' => 'Avantages du service',
        'advantage_one' => 'Haute performance garantie',
        'advantage_two' => 'Support client 24/7',
        'advantage_three' => 'Personnalisable selon vos besoins',
        'key_features' => 'Fonctionnalités clés',
        'feature_one' => 'Fonctionnalité A',
        'feature_one_desc' => 'Description de la fonctionnalité A.',
        'feature_two' => 'Fonctionnalité B',
        'feature_two_desc' => 'Description de la fonctionnalité B.',
        'testimonials' => 'Témoignages de nos clients',
        'testimonial_one' => 'Service incroyable, il a vraiment changé notre manière de travailler.',
        'client_one' => 'Jean Dupont, CEO de Exemple Corp',
        'testimonial_two' => 'Nous avons vu une amélioration immédiate après avoir utilisé ce service.',
        'client_two' => 'Marie Martin, CTO de Startup Innov',
        'cta_button' => 'En savoir plus ?',
        'reserve_button' => 'Réserver le service',
        'back_button' => 'Retour aux services',
    ],
    'serviceCreate' => [
