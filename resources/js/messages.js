...
export const messages = {
    en: {
        ...
        name_length: 'The "{field}" field must be more than 4 characters.',
        email_length: 'The "{field}" field must be more than 6 characters.',
    ...
    fr: {
        ...
        name_length: 'Le champ "{field}" doit contenir plus de 4 caractères.',
        email_length: 'Le champ "{field}" doit contenir plus de 6 caractères.',
    ...
    mg: {
        ...
        name_length: 'Ny sehatra "{field}" dia tsy maintsy manana litera mihoatra ny 4.',
        email_length: 'Ny sehatra "{field}" dia tsy maintsy manana litera mihoatra ny 6.',
        invalid_email: 'Azafady, mampidira adiresy mailaka manankery.',
