...
<div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
    ...
    class="inline-block mt-4 py-2 px-4 max-sm:text-sm text-nowrap bg-blue-600 text-white rounded-md hover:bg-blue-700"
    >Créer une réservation</a>
</div>
    <div class="mt-4 max-sm:text-sm">
        @foreach($reservations as $reservation)
            <div class="flex justify-between p-4 bg-white rounded shadow-sm mb-4">
                <div>
